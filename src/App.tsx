  ...
  const handleAsInquirySubmit = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert('A/S 문의가 접수되었습니다. 담당자가 확인 후 연락드리겠습니다.');
        closeAsInquiryModal();
      } else {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              470,000Hz의 고주파로 이용하여 심부열을 올리는 고주파 자극 의료기기입니다. 
              발만 올리면 30분만에 온열을 전달하여 가정에서 간편하게 사용할 수 있습니다.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div>
              <div className="bg-red-50 p-8 rounded-2xl">
                ...
                <div className="space-y-4 text-gray-700">
                  ...
                  <p className="text-sm">(출처: 니가타대학교 아보 도오루 박사)</p>
                  <p>정상체온에서 1℃만 떨어져도 우리 몸의 면역력은 30% 정도 감소하고, 기초대사율은 12%, 신진대사율에 관여하는 효소의 능력은 50% 정도 감소한다고 알려져 있습니다.</p>
                </div>
              </div>
            </div>
            <div>
          ...
          <div className="bg-gray-900 text-white p-8 rounded-2xl mb-16">
            ...
            <p className="text-gray-300 leading-relaxed">
              ...
              체온이 올라가면 혈관도 확장되어 혈액순환이 정상화 되므로 피가 맑아져 질병에 맞서는 힘이 커집니다. 면역과 체온 그리고 혈액의 이러한 상관관계를 
알고 있다면 가장 중요한 일이 무엇인지는 저절로 알게됩니다. 바로 몸을 따뜻하게 하는 것입니다.            </p>
          </div>
...
생체열을 발생시킵니다. 고주파에 의해 발생된 열을 '심부열(심부체온)' 이라 하는데 올리고365는 이러한 원리로 통증을 완화해줍니다.             </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div>
              ...
              <p className="text-gray-600 leading-relaxed mb-6">
                ...
                고주파는 뼈까지 전기자극이 도달 할 수 있게 해 인체에 가해지면서 분자들이 세포를 올리고, 
                 돌려서 회전하며 충돌해서 심부체온을 올려줍니다.
              </p>
            </div>
            <div>
              <img 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mt-8 text-center text-gray-600">
              <p>최근 5개의 문의만 표시됩니다. 문의 접수 후 담당자가 확인하여 연락드립니다.</p>
            </div>
          </div>
        </div>
      </section>
